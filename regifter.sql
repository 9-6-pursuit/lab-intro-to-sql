...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('signed rookie jersey', 'Kevin Durant', '30000', TRUE),
('cinnamon roll', 'Mom', '0', TRUE),
('cheese on a stick', 'El Loco', '29', FALSE),
('charizard pokemon card', 'eBay', '9999', TRUE),
('mangos', 'La jefa', '5', FALSE)
;
