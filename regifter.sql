...
CREATE TABLE Gifts ( id serial NOT NULL, gift TEXT, giver TEXT, value INT, previously_regifted BOOLEAN );
...
INSERT INTO gifts (gift, giver, value, previously_regifted) VALUES
('peach candle', 'Santa', '9', TRUE),
('peppermint candle', 'Donna', '12', FALSE),
('cashmere mittens', 'Santa', '89', FALSE),
('nutcracker figurine', 'Steve', '25', TRUE),
('target gift card', 'The Boss', '50', FALSE);
