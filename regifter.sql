...
ALTER TABLE houses RENAME price TO value;
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('Laundry Day Scented Candle', 'Ashely', '26', FALSE),
('Hair Brush', 'Delancy', '8', FALSE),
('Vodka', 'Andre', '80', FALSE),
('Washing Machine', 'David', '2000', TRUE),
('Bobs Burgers', 'Bob Belcher', '10', FALSE)
;
