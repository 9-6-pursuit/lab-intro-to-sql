...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('vanilla candle', 'John', 15, FALSE),
('chocolate box', 'Mary', 20, TRUE),
('book: SQL for beginners', 'Alice', 30, FALSE),
('coffee mug', 'Bob', 10, TRUE),
('scented lotion', 'Charlie', 25, FALSE);
...
--
SELECT value, gift FROM gifts WHERE giver = 'Santa';
