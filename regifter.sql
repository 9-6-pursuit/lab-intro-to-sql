...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('apple candle', 'Jason', '12', TRUE),
('bicycle', 'Luke', '190', FALSE),
('basketball', 'Will', '30', FALSE),
('vase', 'Josh', '39', TRUE),
('board game', 'James', '49', FALSE)
;
...
--
SELECT * FROM gifts WHERE gift LIKE '%candle%' RETURNING gift;
