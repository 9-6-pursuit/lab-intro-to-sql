...
-- 
\echo Alter the table so that the column price is changed to value (ignored)
-- 
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
  ('lavender candle', 'Emily', 8, false),
  ('scented bath bombs', 'Elsa', 15, false),
  ('coffee mug', 'John', 7, false),
  ('handmade scarf', 'Sarah', 12, false),
  ('chocolate box', 'Alex', 10, true);
...
--
SELECT * FROM gifts ORDER BY value DESC OFFSET 2 LIMIT 3;
